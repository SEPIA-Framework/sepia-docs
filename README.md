...
## Downloads
* SEPIA-Home (Server, Web-App + Apk, Tools): [v2.4.1](https://github.com/SEPIA-Framework/sepia-installation-and-setup/releases)
* Android Play Store: [v0.21.0](https://play.google.com/store/apps/details?id=de.bytemind.sepia.app.web)
